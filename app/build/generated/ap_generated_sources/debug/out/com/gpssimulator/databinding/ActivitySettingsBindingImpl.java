...
public class ActivitySettingsBindingImpl extends ActivitySettingsBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.mockLocationSwitch, 3);
        sViewsWithIds.put(R.id.notificationSwitch, 4);
        sViewsWithIds.put(R.id.speedVariationSeekBar, 5);
        sViewsWithIds.put(R.id.speedVariationValue, 6);
    }
    // views
    @NonNull
