  ...
  public RouteDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfRouteEntity = new EntityInsertionAdapter<RouteEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `routes` (`id`,`name`,`points`,`totalDistance`,`estimatedDuration`,`basePaceSeconds`,`createdAt`,`isCompleted`,`actualDuration`,`completedAt`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        final String _tmp = __converters.fromLocationPointList(entity.getPoints());
        if (_tmp == null) {
          statement.bindNull(3);
        } else {
          statement.bindString(3, _tmp);
        }
        statement.bindDouble(4, entity.getTotalDistance());
        statement.bindLong(5, entity.getEstimatedDuration());
        statement.bindLong(6, entity.getBasePaceSeconds());
        ...
        statement.bindLong(9, entity.getActualDuration());
    ...
    this.__updateAdapterOfRouteEntity = new EntityDeletionOrUpdateAdapter<RouteEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `routes` SET `id` = ?,`name` = ?,`points` = ?,`totalDistance` = ?,`estimatedDuration` = ?,`basePaceSeconds` = ?,`createdAt` = ?,`isCompleted` = ?,`actualDuration` = ?,`completedAt` = ? WHERE `id` = ?";
      }
    ...
    return CoroutinesRoom.createFlow(__db, false, new String[] {"routes"}, new Callable<List<RouteEntity>>() {
      ...
      public List<RouteEntity> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfBasePaceSeconds = CursorUtil.getColumnIndexOrThrow(_cursor, "basePaceSeconds");
          ...
          while (_cursor.moveToNext()) {
            ...
            final List<LocationPoint> _tmpPoints;
            final String _tmp;
            ...
            _tmpPoints = __converters.toLocationPointList(_tmp);
            ...
            final int _tmpBasePaceSeconds;
            _tmpBasePaceSeconds = _cursor.getInt(_cursorIndexOfBasePaceSeconds);
            ...
            _item = new RouteEntity(_tmpId,_tmpName,_tmpPoints,_tmpTotalDistance,_tmpEstimatedDuration,_tmpBasePaceSeconds,_tmpCreatedAt,_tmpIsCompleted,_tmpActualDuration,_tmpCompletedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public RouteEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _tmpCompletedAt = __converters.toTimestamp(_tmp_4);
            _result = new RouteEntity(_tmpId,_tmpName,_tmpPoints,_tmpTotalDistance,_tmpEstimatedDuration,_tmpBasePaceSeconds,_tmpCreatedAt,_tmpIsCompleted,_tmpActualDuration,_tmpCompletedAt);
          } else {
            _result = null;
          }
          return _result;
